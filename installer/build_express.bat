...
vcexpress /build release %TERATERMSLN% /project svnrev /projectconfig release

:svnrev
..\teraterm\release\svnrev.exe ..\libs\svn\bin\svnversion.exe .. ..\teraterm\ttpdlg\svnversion.h

:build
vcexpress /%BUILD% release %TERATERMSLN%
if ERRORLEVEL 1 goto fail
vcexpress /%BUILD% release %TTSSHSLN%
if ERRORLEVEL 1 goto fail
vcexpress /%BUILD% release %TTPROXYSLN%
if ERRORLEVEL 1 goto fail
vcexpress /%BUILD% release %TTXKANJISLN%
if ERRORLEVEL 1 goto fail
vcexpress /%BUILD% release %TTPMENUSLN%
if ERRORLEVEL 1 goto fail
vcexpress /%BUILD% release %TTXSAMPLESLN%
if ERRORLEVEL 1 goto fail
